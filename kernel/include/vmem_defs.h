...
#define VUSER_TRAPFRAME_ADDR 0x3FFFFFFFFF
...
#define VKERNEL_VA2PA(va) (((unsigned long)(va)) & (~VMEM_KERNEL_SPACE_VA_BEGIN))
#define VKERNEL_PA2VA(pa) (((unsigned long)(pa)) | VMEM_KERNEL_SPACE_VA_BEGIN)
